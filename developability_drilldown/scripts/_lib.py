...
# Expected registry sizes after H114–H125 SOURCE24 fusion (+12) and H126–H127 SAP24 XGB (+2)
N_EXPERIMENTS_TOTAL = 268  # 266 after H114–H125 + 2 XGB
...
N_TRANSFORMER = 178  # 166 prior HSP + 12 SOURCE24 fusion
