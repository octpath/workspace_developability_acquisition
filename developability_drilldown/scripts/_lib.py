...
# Expected registry sizes after H128–H133 residue F1 SURFACE (+6)
N_EXPERIMENTS_TOTAL = 274  # 268 after H126–H127 + 6 residue F1
...
N_TRANSFORMER = 184  # 178 prior + 6 residue F1 SURFACE
